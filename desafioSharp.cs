...
foreach (string name in studentNames)
{
    ...
    int gradeExtraCreditsAssignments = 0;
    ...
    */
    ...
    foreach (int score in studentScores)
    {
        ...
        {
            gradeExtraCreditsAssignments += 1;
    ...
    currentStudentExtraCreditScore = (decimal)(sumExtraCreditScores) / gradeExtraCreditsAssignments;
